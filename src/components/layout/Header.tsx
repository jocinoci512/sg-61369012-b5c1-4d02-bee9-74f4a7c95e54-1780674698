      ...
      <header className="border-b border-border bg-card backdrop-blur-sm sticky top-0 z-50 shadow-md">
        <div className="container h-20 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            <Link href="/teams" className="text-sm font-semibold text-foreground hover:text-primary transition-colors">
              Teams
            </Link>
            <Link href="/testimonials" className="text-sm font-semibold text-foreground hover:text-primary transition-colors">
              Testimonials
            </Link>
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-[320px]">
                ...
                <nav className="flex flex-col gap-6">
                  ...
                  <Link href="/teams" className="text-base font-semibold text-foreground hover:text-primary transition-colors py-2 border-b border-border">
                    Teams
                  </Link>
                  <Link href="/testimonials" className="text-base font-semibold text-foreground hover:text-primary transition-colors py-2 border-b border-border">
                    Testimonials
                  </Link>

  ...
  return (
    <section className="py-20 md:py-28 bg-background">
      <div className="container">
        ...
        {/* Live Status Bar */}
        <div className="bg-primary rounded-2xl p-6 mb-16 border border-border shadow-lg">
        ...
        <div className="bg-muted rounded-2xl p-10 border border-border">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {certifications.map((cert, index) => (
              <div key={index} className="bg-card rounded-xl p-6 border border-border text-center hover:shadow-lg transition-all duration-300">
